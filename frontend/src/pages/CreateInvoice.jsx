...
const CreateInvoice = () => {
  ...
  const handleSaveInvoice = async () => {
    ...
    const invoiceData = {
      ...
      customer_ship_address: selectedCustomer.address_2 || null,
      customer_ship_city: selectedCustomer.city_2 || null,
      customer_ship_state: selectedCustomer.state_2 || null,
      customer_ship_pincode: selectedCustomer.pincode_2 || null,
      customer_phone_2: selectedCustomer.phone_2 || null,
          ...
          {items.some(item => item.confirmed) && (
            <div className="flex justify-end pt-4">
              <Button 
                ...
                size="lg"
                disabled={!selectedCustomer || !items.some(item => item.confirmed)}
